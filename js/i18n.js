...
(function () {
  ...
  const t = {
    en: {
      ...
      'resume.skills': 'Core Stack & Capabilities',
      'resume.offer': 'What I Can Build For You',
      'resume.offer1.title': 'Web Applications & Marketplaces',
      'resume.offer1.desc': 'Full-stack SaaS apps built with React, Next.js, and Supabase. From custom marketplaces to high-traffic internal tools.',
      'resume.offer2.title': 'Chrome Extensions (MV3)',
      'resume.offer2.desc': 'Published on Chrome Web Store. Built with Manifest V3, TypeScript, background service workers, and payment licensing.',
      'resume.offer3.title': 'SaaS & Realtime Systems',
      'resume.offer3.desc': 'Multi-tenant architecture, multi-role RBAC access, live WebSocket sync, automated QRIS/Stripe billing, and admin dashboards.',
      'resume.offer4.title': 'High-Performance Websites',
      'resume.offer4.desc': 'Bespoke, anti-slop interfaces optimized for core web vitals, SEO ranking, and high conversion rates.',
      'resume.photo': 'Mohammad Yasrul profile photo',
      'resume.location': 'Indonesia &middot; UTC+7',
      'resume.availability': 'Available for projects',
      'resume.stack.frontend': 'Frontend Engine',
      'resume.stack.backend': 'Backend & Cloud',
      'resume.stack.tools': 'Architecture & Tools',
      ...
      'approach.tile1.title': 'Speed with Taste',
      'approach.tile1.desc': 'Modern tooling & AI let me move fast, but I refuse to ship half-baked, templated code.',
      'approach.tile2.title': 'Honest Scope',
      'approach.tile2.desc': 'Clear about trade-offs and realistic delivery. Better to lose a project than overpromise.',
      'approach.tile3.title': 'Built to Last',
      'approach.tile3.desc': 'Clean architecture, modular structure, and clear docs — even on small projects.',
    ...
    id: {
      ...
      'resume.cv': 'Unduh CV',
      'resume.skills': 'Stack & Kapabilitas Utama',
      'resume.offer': 'Yang Bisa Saya Bangun Untuk Anda',
      'resume.offer1.title': 'Aplikasi Web & Marketplace',
      'resume.offer1.desc': 'Aplikasi SaaS full-stack dengan React, Next.js, dan Supabase. Dari marketplace kustom hingga internal tools performa tinggi.',
      'resume.offer2.title': 'Chrome Extension (MV3)',
      'resume.offer2.desc': 'Terbit di Chrome Web Store. Dibangun dengan Manifest V3, TypeScript, background service workers, dan sistem lisensi.',
      'resume.offer3.title': 'SaaS & Sistem Realtime',
      'resume.offer3.desc': 'Arsitektur multi-tenant, kontrol akses RBAC multi-role, sinkronisasi WebSocket realtime, pembayaran otomatis QRIS/Stripe, & dashboard admin.',
      'resume.offer4.title': 'Website Performa Tinggi',
      'resume.offer4.desc': 'Tampilan kustom anti-slop yang dioptimasi untuk core web vitals, peringkat SEO, dan tingkat konversi tinggi.',
      'resume.photo': 'Foto profil Mohammad Yasrul',
      'resume.location': 'Indonesia &middot; UTC+7',
      'resume.availability': 'Tersedia untuk proyek',
      'resume.stack.frontend': 'Frontend Engine',
      'resume.stack.backend': 'Backend & Cloud',
      'resume.stack.tools': 'Arsitektur & Tools',
      ...
      'approach.tile1.title': 'Kecepatan Berkelas',
      'approach.tile1.desc': 'Tools modern & AI membuat saya bergerak cepat, tapi saya menolak hasil yang asal-asalan.',
      'approach.tile2.title': 'Skop yang Jujur',
      'approach.tile2.desc': 'Jujur tentang batas kemampuan & estimasi realistis. Lebih baik bicara jujur daripada janji berlebihan.',
      'approach.tile3.title': 'Didesain Tahan Lama',
      'approach.tile3.desc': 'Arsitektur bersih, struktur modular, dan dokumentasi rapi — bahkan untuk proyek kecil.',

      // ── BLOG ──
      'blog.label': 'TULISAN',
      'blog.heading': 'Pemikiran tentang building',
      'blog.p1.date': 'Mei 2026',
      'blog.p1.readtime': '5 mnt baca',
